...
public class NeomanJoint {
     ...
     * @return 返回拼单后的结果
     */
    public OrderBill mergeNeoman(OrderBill body) throws NeomanException {
        ...
        body.joinInfoNode(neomanOrderBill);
        return body;
    }
}
